...
export HF_HUB_CACHE_MOUNT='/data/hf_home/hub'
...
for tp in 8; do 
  ...
  #for isl_osl in "128,16,dsr1"; do # testing
    ...
    #export IMAGE=rocm/sgl-dev:v0.5.4.post1-rocm700-mi35x-20251028-srt
    #export IMAGESHORTNAME=rocm_sgl-dev_v0.5.4-rocm700-mi35x-20251028

    #export IMAGE=rocm/7.0:rocm7.0_ubuntu_22.04_sgl-dev-v0.5.2-rocm7.0-mi35x-20250915
    #export IMAGESHORTNAME=rocm7.0_sgl-dev_v0.5.2-rocm700-mi35x-20250915

    #export IMAGE=lmsysorg/sglang:v0.5.4.post2-rocm700-mi35x
    #export IMAGESHORTNAME=lmsysorg_sglang_v0.5.4.post2-rocm700-mi35x

    export IMAGE=lmsysorg/sglang:v0.5.5.post2-rocm700-mi35x
    export IMAGESHORTNAME=lmsysorg_sglang_v0.5.5.post2-rocm700-mi35x
